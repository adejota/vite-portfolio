...
const pt = {
  ...
  doingListItems: [
    ...
    {
      title: "Git flow",
      content: "Controle do versionamento do código e deploy do sistema",
      icon: "GitHub",
    },
    {
      title: "Gestão de pessoas ",
      content: "Responsável pelo code-review, atribuição de tarefas e prazos",
      icon: "UserGroup",
    },
  ],
  educationListItems: [
  ...
  portfolioListItems: [
    ...
    },
    {
      ...
      title: "Memory game",
      content:
        "Um jogo de memória para mostrar para a minha sobrinha que o meu trabalho é legal!",
    ...
    },
    {
      name: "portfolio-1",
      title: "Portfólio",
      content: "Portfólio para iniciar minha carreira como desenvolvedor.",
